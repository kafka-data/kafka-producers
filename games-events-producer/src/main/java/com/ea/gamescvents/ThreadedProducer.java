...
import com.ea.gamescvents.threads.Dispatcher;
...
public class ThreadedProducer {
    ...
    public static void main(String[] args){
        ...
        for(int i=0;i<AppConfigs.eventFiles.length;i++){
            dispatchers[i]=new Thread(new Dispatcher(producer,AppConfigs.topicNameThreadedProducer,AppConfigs.eventFiles[i]));
            dispatchers[i].start();
        }
